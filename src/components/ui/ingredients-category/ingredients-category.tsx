...
>(
  (
    { title, titleRef, ingredients, ingredientsCounters, ...restProps },
    ref
  ) => (
    <>
      ...
      <ul
        ...
        ref={ref}
        {...restProps} // Позволяет передать data-testid на ul
      >
        {ingredients.map((ingredient) => (
          <BurgerIngredient
            ...
            data-testid='ingredient-card' // Добавлено для каждой карточки
          />
        ))}
      </ul>
    </>
